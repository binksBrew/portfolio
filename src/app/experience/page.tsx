...
export default function ExperiencePage() {
  ...
  const maxFadeScroll = window.innerHeight * 0.6
  ...
  return (
    <div className="relative w-full bg-black">
      ...
      {/* === Top Text Blocks === */}
      <div
        className="fixed top-[20%] left-[50px] z-20"
      ...
      <div
        className="fixed top-[45%] right-[50px] z-20 w-[383px] text-[#FFFFFF] font-ibm text-[20px] leading-[100%]"
        style={{ opacity: fadeOutOpacity }}
      >
...
>
                ...
                {/* <p className="text-[10.75px] font-ibm leading-[100%]"> */}
